...
public class frag1 extends Fragment {
            ...
            if (menuItem.getItemId() == R.id.refresh) {
                {
                    ...
                    Runnable afterRun = () -> {
                        ...
                        getActivity().runOnUiThread(() -> {
                            ...
                            final option1Activity.RecyclerViewAdapterSubwayResult adapter = new RecyclerViewAdapterSubwayResult(arrivalList);
                            binding.recyclerviewOp1SubwayResult.setAdapter(adapter);
                        });
                    };

                    // Thread를 실행한다
                    subwayApiThread = new SubwayApiThread(getActivity(), arrivalList, departureStation, arrivalStation, afterRun);
...

                {
                    ...
                    Runnable afterRun = () -> {
                        getActivity().runOnUiThread(() -> {
                            ...
                            final option1Activity.RecyclerViewAdapterBusResult adapter = new RecyclerViewAdapterBusResult(arrivalList);
    ...
    // RecyclerView
    class RecyclerViewAdapterBusResult extends RecyclerView.Adapter<option1Activity.RecyclerViewAdapterBusResult.ViewHolder> {
        ...
        @Override
        public void onBindViewHolder(@NonNull option1Activity.RecyclerViewAdapterBusResult.ViewHolder holder, int position) {
    ...
    class RecyclerViewAdapterSubwayResult extends RecyclerView.Adapter<RecyclerViewAdapterSubwayResult.ViewHolder> {
        ...
        @NonNull
        @Override
        public option1Activity.RecyclerViewAdapterSubwayResult.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            RecyclerviewItemSubwayArrivalBinding binding = RecyclerviewItemSubwayArrivalBinding.
                    inflate(LayoutInflater.from(parent.getContext()), parent, false);
            return new option1Activity.RecyclerViewAdapterSubwayResult.ViewHolder(binding);
        }

        @Override
        public void onBindViewHolder(@NonNull option1Activity.RecyclerViewAdapterSubwayResult.ViewHolder holder, int position) {
