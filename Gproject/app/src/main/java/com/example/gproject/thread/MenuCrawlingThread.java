...
import com.example.gproject.database.MenuEntity;
                    ...
                    switch (mealtime) {
                        case 0: // 학생회관 점심
                            for(String menuItem : menus) {
                                menuDAO.insert(new MenuEntity(day, 2, 1, menuItem));
                            }
                            break;
                        case 1: // 학생회관 저녁
                            for(String menuItem : menus) {
                                menuDAO.insert(new MenuEntity(day, 3, 1, menuItem));
                            }
                            break;
                        case 2: // 교직원식당 점심
                            for(String menuItem : menus) {
                                menuDAO.insert(new MenuEntity(day, 2, 2, menuItem));
                            }
                            break;
                        case 3: // 교직원식당 저녁
                            for(String menuItem : menus){
                                menuDAO.insert(new MenuEntity(day, 3, 2, menuItem));
                            }
                            break;
                        case 4: // 제2기숙사식당 아침
                            for(String menuItem : menus){
                                menuDAO.insert(new MenuEntity(day, 1, 3, menuItem));
                            }
                            break;
                        case 5: // 제2기숙사식당 점심
                            for(String menuItem : menus){
                                menuDAO.insert(new MenuEntity(day, 2, 3, menuItem));
                            }
                            break;
                        ...
                        case 7: // 제2기숙사식당 저녁
                            for(String menuItem : menus){
                                menuDAO.insert(new MenuEntity(day, 3, 3, menuItem));
                            }
                            break;
                    }
                    index++;
